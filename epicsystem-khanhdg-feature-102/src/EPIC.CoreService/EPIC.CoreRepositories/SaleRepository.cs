...
namespace EPIC.CoreRepositories
{
    ...
    {
        private const string PROC_SALE_ADD_TEMP = "EPIC.PKG_CORE_SALE.PROC_SALE_ADD_TEMP";
        private const string PROC_SALE_DELETE = "EPIC.PKG_CORE_SALE.PROC_SALE_DELETE";
        private const string PROC_SALE_GET = "EPIC.PKG_CORE_SALE.PROC_SALE_GET";
        private const string PROC_SALE_GET_ALL = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_ALL";
        private const string PROC_SALE_TEMP_GET_ALL = "EPIC.PKG_CORE_SALE.PROC_SALE_TEMP_GET_ALL";
        private const string PROC_SALE_GET_ALL_MANAGER = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_ALL_MANAGER";
        private const string PROC_SALE_GET_BY_INVESTOR_ID = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_BY_INVESTOR_ID";
        private const string PROC_SALE_FIND_TEMP_BY_ID = "EPIC.PKG_CORE_SALE.PROC_SALE_FIND_TEMP_BY_ID";
        private const string PROC_SALE_FIND_BY_ID = "EPIC.PKG_CORE_SALE.PROC_SALE_FIND_BY_ID";
        private const string PROC_SALE_TEMP_REQUEST = "EPIC.PKG_CORE_SALE.PROC_SALE_TEMP_REQUEST";
        private const string PROC_SALE_APPROVE = "EPIC.PKG_CORE_SALE.PROC_SALE_APPROVE";
        private const string PROC_SALE_TEMP_UPDATE = "EPIC.PKG_CORE_SALE.PROC_SALE_TEMP_UPDATE";
        private const string PROC_SALE_UPDATE = "EPIC.PKG_CORE_SALE.PROC_SALE_UPDATE";
        private const string PROC_SALE_ACTIVE = "EPIC.PKG_CORE_SALE.PROC_SALE_ACTIVE";
        private const string PROC_SALE_TEMP_DELETE = "EPIC.PKG_CORE_SALE.PROC_SALE_TEMP_DELETE";
        private const string PROC_SALE_GET_BY_ID = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_BY_ID";
        private const string PROC_SALE_TEMP_UPDATE_CMS = "EPIC.PKG_CORE_SALE.PROC_SALE_TEMP_UPDATE_CMS";
        private const string PROC_SALE_CANCEL = "EPIC.PKG_CORE_SALE.PROC_SALE_CANCEL";
        private const string PROC_SALE_BY_REFERALL_CODE = "EPIC.PKG_CORE_SALE.PROC_SALE_BY_REFERALL_CODE";
        private const string PROC_FIND_ALL_SALE_BUSINESS = "EPIC.PKG_CORE_SALE.PROC_FIND_ALL_SALE_BUSINESS";
        private const string PROC_GET_ALL_BUSINESS_TRADING_SALE = "EPIC.PKG_CORE_SALE.PROC_GET_ALL_BUS_TRADING_SALE";
        private const string PROC_FIND_ALL_TRADING_UP = "EPIC.PKG_CORE_SALE.PROC_FIND_ALL_TRADING_UP";

        private const string PROC_APP_SALE_REGISTER = "EPIC.PKG_CORE_SALE.PROC_APP_SALE_REGISTER";
        private const string PROC_APP_LIST_SALE_REGISTER = "EPIC.PKG_CORE_SALE.PROC_APP_LIST_SALE_REGISTER";
        private const string PROC_APP_SALE_DIRECTION_SALE = "EPIC.PKG_CORE_SALE.PROC_APP_SALE_DIRECTION_SALE";
        private const string PROC_APP_LIST_TRADING_PROVIDER = "EPIC.PKG_CORE_SALE.PROC_APP_LIST_TRADING_PROVIDER";
        private const string PROC_APP_SALE_STATUS = "EPIC.PKG_CORE_SALE.PROC_APP_SALE_STATUS";
        private const string PROC_APP_SALE_BY_ID = "EPIC.PKG_CORE_SALE.PROC_APP_SALE_BY_ID";
        private const string PROC_APP_LIST_TRADING_BY_SALE = "EPIC.PKG_CORE_SALE.PROC_APP_LIST_TRADING_BY_SALE";
        private const string PROC_SALE_REGISTER_GET_ALL = "EPIC.PKG_CORE_SALE.PROC_SALE_REGISTER_GET_ALL";
        private const string PROC_SALE_TEMP_SIGN = "EPIC.PKG_CORE_SALE.PROC_SALE_TEMP_SIGN";
        private const string PROC_SALE_GET_COLLAB_CONTRACT = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_COLLAB_CONTRACT";
        private const string PROC_APP_FIND_SALE_CHILD = "EPIC.PKG_CORE_SALE.PROC_APP_FIND_SALE_CHILD";
        private const string PROC_APP_MANAGER_SALE_CHILD = "EPIC.PKG_CORE_SALE.PROC_APP_MANAGER_SALE_CHILD";
        private const string PROC_SALE_REGISTER_GET_TRADING = "EPIC.PKG_CORE_SALE.PROC_SALE_REGISTER_GET_TRADING";
        private const string PROC_SALE_GET_TRADING_IN_TEMP = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_TRADING_IN_TEMP";
        private const string PROC_APP_SALE_OVERVIEW = "EPIC.PKG_CORE_SALE.PROC_APP_SALE_OVERVIEW";
        private const string PROC_APP_GET_REGISTER_BY_INVESTOR = "EPIC.PKG_CORE_SALE.PROC_APP_REGISTER_BY_INVESTOR";
        private const string PROC_FIND_TEMP_BY_REGISTER_ID = "EPIC.PKG_CORE_SALE.PROC_FIND_TEMP_BY_REGISTER_ID";
        private const string PROC_SALE_CANCEL_REGISTER = "EPIC.PKG_CORE_SALE.PROC_SALE_CANCEL_REGISTER";
        private const string PROC_LIST_SALE_BY_PARENT_SALE = "EPIC.PKG_CORE_SALE.PROC_LIST_SALE_BY_PARENT_SALE";
        private const string PROC_SALE_GET_DATA_REGISTER = "EPIC.PKG_CORE_SALE.PROC_SALE_GET_DATA_REGISTER";
        private const string PROC_GET_SALE_INFO_BY_REFFERAL_CODE = "EPIC.PKG_CORE_SALE.PROC_DEPART_SALE_N_NAME_SALE"; // lấy thông tin tên sale và phòng ban sale bằng refferal code
        private const string PROC_GET_BUSINESS_SALE_INFO_BY_REFFERAL_CODE = "EPIC.PKG_CORE_SALE.PROC_DEPART_BUSI_SALE"; //lấy thông tin tên sale và phòn ban sale của sale business
        private const string PROC_GET_CAP_DUOI_SALE_BY_SALE_ID = "EPIC.PKG_SALE_APP_STATISTICAL.FIND_SALE_CAP_DUOI_BY_SALE_ID"; //lấy thông tin của cấp dưới của sale bằng sale id
        private const string PROC_APP_SALE_DOANH_SO = "EPIC.PKG_CORE_SALE.PROC_APP_SALE_DOANH_SO"; //lấy thông tin hợp đồng sale bằng sale id
        private const string PROC_APP_THONG_KE_KH = "EPIC.PKG_CORE_SALE.PROC_APP_THONG_KE_KH";
        private const string PROC_APP_SALE_THONG_KE_HOP_DONG = "EPIC.PKG_SALE_APP_STATISTICAL.FIND_HOP_DONG_SALE_APP";
        private const string PROC_SALE_INFO_BY_REFERALL_CODE = "EPIC.PKG_CORE_SALE.PROC_SALE_INFO_BY_REFERALL_CODE";
        private const string PROC_SALE_FIND_CORE_SALE = "EPIC.PKG_CORE_SALE.PROC_SALE_FIND_CORE_SALE";
        private const string PROC_SALE_UPDATE_AUTO_DIRECTIONAL = "EPIC.PKG_CORE_SALE.PROC_SALE_UPDATE_AUTO_DIRECTIONAL";
        private const string PROC_SALE_CHECK_SALE_TYPE_NOT_COLLABORATOR = "EPIC.PKG_CORE_SALE.PROC_SALE_CHECK_SALE_TYPE_NOT_COLLABORATOR";
        private const string PROC_GET_DEPARMENTS_BY_SALE_ID = "EPIC.PKG_CORE_SALE.PROC_GET_DEPARMENTS_BY_SALE_ID";
        private const string PROC_SALE_TONG_DOANH_SO = "EPIC.PKG_CORE_EXCEL_REPORT.PROC_SALE_DOANH_SO";
        private const string PROC_GET_SALER_LIST_EXCEL = "EPIC.PKG_CORE_EXCEL_REPORT.PROC_LIST_SALE_EXCEL";
